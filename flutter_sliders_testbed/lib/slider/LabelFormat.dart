...
class SliderLabelFormatPage extends StatefulWidget {
  @override
  _SliderLabelFormatPageState createState() => _SliderLabelFormatPageState();
}

class _SliderLabelFormatPageState extends State<SliderLabelFormatPage> {
  double _min = 20;
  double _max = 90;
